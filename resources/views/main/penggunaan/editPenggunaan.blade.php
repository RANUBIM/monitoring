        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit Penggunaan Bahan</div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="/update-penggunaanBahan/{{ $datas->uuid }}"
                                    method="POST">
                                    @method('GET')
                                    @csrf
                                    {{-- <input type="text" name="namaLog" value="{{ $datas->alat_id->nama }}"> --}}
                                    <input type="hidden" name="uuid" value="{{ $validatedData['uuid'] }}">
                                    <input type="hidden" name="uuidBahan" value="{{ $validatedData['uuidBahan'] }}">
                                    ...
                                    <div class="form-group">
                                        <label>Bahan</label>
                                        <select id="bahan_id" class="form-control @error('bahan_id') is-invalid @enderror select2" name="bahan_id" style="width: 100%;" >
