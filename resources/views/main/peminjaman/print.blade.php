        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="detail-judul" style="font-size: 15px;">
                    <strong>DAFTAR PEMINJAMAN ALAT PRAKTEK KEJURUAN/EKSKUL</strong>
                </div>
                </center>
            </div>
            <div class="col-3">
            ...
            <div style="line-height: 1; margin-top: 10px;">
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            : {{ \Carbon\Carbon::parse($datas->tgl_peminjaman)->translatedFormat('d M Y') }} hingga {{ \Carbon\Carbon::parse($datas->tgl_pengembalian)->translatedFormat('d M Y') }}
                        </div>
                    </div>
            ...
            <div class="col-6">
                <div style="margin-bttom:10px; overflow:auto;">
                    <table align="right" width="320">
                        ...
                        <tr>
                            <td style=" border-bottom: 1px solid #000; ">Peminjam</td>
                            {{-- <td style=" border-bottom: 1px solid #000;">: </td>
                            <td style=" border-bottom: 1px solid #000;"> --}}
